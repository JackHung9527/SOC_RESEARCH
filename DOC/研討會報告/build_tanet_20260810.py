# -*- coding: utf-8 -*-
"""
Build the TANET conference paper (version 20260810) directly ON TOP OF the official
...
OUT_DOCX = os.path.join(
    ...
    "for_Lithium-ion_Batteries_20260810.docx")
...
def add_figure(path, width_cm, caption, *, span=False):
    ...
    if span:
        # close the running 2-column section on a spacer paragraph
        sp = p(S_CENTER, "")
